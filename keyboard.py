...
def affix_keyboard(state):
    ...
    raiting_button = InlineKeyboardButton('Добавить критерий по рейтингу', callback_data='affix_raiting')
    ...
    del_raiting_button = InlineKeyboardButton('Удалить критерий по рейтингу', callback_data='del_affix_raiting')
